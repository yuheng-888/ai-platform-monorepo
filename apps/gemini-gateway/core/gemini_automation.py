...
from embedded.gemini_business2api.core.base_task_service import TaskCancelledError
...
class GeminiAutomation:
    ...
    def _save_network_packets(self, packets) -> None:
        """保存网络日志（仅用于调试）"""
        try:
            from embedded.gemini_business2api.core.storage import _data_file_path
