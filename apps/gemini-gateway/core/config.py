...
class BasicConfig(BaseModel):
    ...
    register_default_concurrency: int = Field(default=1, ge=1, le=50, description="默认注册并发数")
    register_max_concurrency: int = Field(default=10, ge=1, le=50, description="注册最大并发数")
...
class ConfigManager:
    ...
    def load(self):
        ...
        register_default_concurrency_raw = basic_data.get("register_default_concurrency", 1)
        register_max_concurrency_raw = basic_data.get("register_max_concurrency", 10)
        ...
        basic_config = BasicConfig(
            ...
            register_default_concurrency=int(register_default_concurrency_raw),
            register_max_concurrency=int(register_max_concurrency_raw),
