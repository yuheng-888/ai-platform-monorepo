  ...
  useEffect(() => {
    apiFetch('/config').then((cfg) => {
      ...
      form.setFieldsValue({
        ...
        concurrency: form.isFieldTouched('concurrency') ? form.getFieldValue('concurrency') : nextConcurrency,
    ...
    const res = await apiFetch('/tasks/register', {
      ...
      body: JSON.stringify({
        ...
        extra: {
          ...
          moemail_domain: values.moemail_domain,
        ...
        <Card title="邮箱配置" style={{ marginBottom: 16 }}>
          ...
          {mailProvider === 'moemail' && (
            <>
              ...
              <Form.Item name="moemail_api_key" label="API Key">
                <Input.Password placeholder="YOUR_API_KEY" />
              </Form.Item>
