...
from embedded.gemini_business2api.core.account import RetryPolicy, update_accounts_config
...
class BaseTaskService(Generic[T]):
    ...
    def _save_task_history_best_effort(self, task: T) -> None:
        try:
            from embedded.gemini_business2api.main import save_task_to_history
