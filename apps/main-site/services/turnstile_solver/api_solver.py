...
def get_camoufox_launch_options(headless: bool) -> dict:
    """Disable the default UBO addon so a failed addon download does not break startup."""
...
class TurnstileAPIServer:
    ...
    async def _initialize_browser(self) -> None:
        ...
        if self.browser_type in ['chromium', 'chrome', 'msedge']:
            ...
            camoufox = AsyncCamoufox(**get_camoufox_launch_options(self.headless))
