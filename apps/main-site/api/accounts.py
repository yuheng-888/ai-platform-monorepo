...
@router.get("/chatgpt-restock-summary")
def get_chatgpt_restock_summary():
    from services.auto_restock import get_chatgpt_restock_summary

    return get_chatgpt_restock_summary()


@router.get("/cliproxyapi-pool-summary")
def get_cliproxyapi_pool_summary():
    from services.cliproxyapi_pool_stats import get_cliproxyapi_pool_summary

    return get_cliproxyapi_pool_summary()
